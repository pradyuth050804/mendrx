...
public class CreateSupplementBrandGuidelineRequestModel {
    ...
    // Constructors
    public CreateSupplementBrandGuidelineRequestModel() {}

    public CreateSupplementBrandGuidelineRequestModel(String supplementName, String brandName, String productLink, String guidelines) {
